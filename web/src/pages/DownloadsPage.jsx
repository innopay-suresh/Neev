                        ...
                        <div className={styles.troubleNote}>
                          ...
                          {platform === 'macos-desktop' && installer.filename.endsWith('.dmg') && (
                            <div className={styles.hintText}>
                              <strong>DMG installer (recommended):</strong> Open the <code>.dmg</code> file and drag <code>NeevRemote.app</code> to the <strong>Applications</strong> folder (choose <strong>Replace</strong> if an older version is already there).
                              If Gatekeeper blocks, run: <code>xattr -dr com.apple.quarantine /Applications/NeevRemote.app</code>
                            </div>
                          )}
                          {platform === 'macos-desktop' && installer.filename.endsWith('.zip') && (
                            <div className={styles.hintText}>
                              ...
                              Or manually: <code>xattr -dr com.apple.quarantine NeevRemote.app</code> then drag to Applications.
                            </div>
                          )}
